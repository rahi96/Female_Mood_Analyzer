...
class Settings(BaseSettings):
    ...
    CYCLE_ENGINE_SNAPSHOT_URL: str = "https://api.fightthenumber.com/api/v1/snapshot"
    CYCLE_CALENDAR_INPUTS_URL: str = "https://api.fightthenumber.com/api/v1/cycle-calendar-inputs"
    HEALTH_TRENDS_HEALTH_LOGS_URL: str = "https://api.fightthenumber.com/api/v1/health-log/today"
